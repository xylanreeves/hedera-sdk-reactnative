...
import MnemonicInput from '../../../components/mnemonicScreen/mnemonicInput'
import { commonStyles } from '../../../styles/commonStyles'

const MnemonicScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={[commonStyles.headerView, { height: '24%' }]}>
        <View>
          <Text
            style={{
              fontSize: 20,
            ...
            >
              {({
                ...
                <>
                  ...
                  >
                    <Text style={{ fontFamily: customFonts.Varela }}>
                      Submit
                    </Text>
                  </TouchableOpacity>
                </>
